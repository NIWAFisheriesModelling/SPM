...
\begin{enumerate}
  \item Determine the parameters to be estimated (see Section \ref{estimate-free-parameters})
  \item Calculate a point estimate, i.e., the maximum posterior density estimate (MPD) (see Section \ref{estimate-MPD}).
  \item Calculate a posterior profile selected parameters, i.e., find, for each of a series of values of a parameter, allowing the other estimated parameters to vary, the minimum value of the objective function (see Section \ref{estimate-profiles}).
  \item Generate an MCMC sample from the posterior distribution (see Section \ref{estimate-MCMC}).
  \item Calculate the approximate covariance matrix of the parameters as the inverse of the minimizer\textquoteright{}s approximation to the Hessian, and the corresponding correlation matrix (see Section \ref{estimate-MPD}).
\end{enumerate}

\subsection{Specifying the parameters to be estimated\label{estimate-free-parameters}}
...
\subsection{Point estimation\label{estimate-MPD}}
...
\subsection{Posterior profiles\label{estimate-profiles}}
...
\subsection{Bayesian estimation\label{estimate-MCMC}}
