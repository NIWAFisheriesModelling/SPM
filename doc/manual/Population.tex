...
\item The \subcommand{DoubleNormal}\ preference function has dependent variable $x$ and parameters $\theta=(\mu,\sigma_L,\sigma_R)$, and is defined as,
\begin{equation}
...
\item The \subcommand{InverseLogistic}\ preference function has dependent variable $x$ and parameters $\theta = (a_{50},a_{to95})$, and is defined as,
\begin{equation}
  f(x | a_{50}, a_{to95}) =1- 1 / [1+19^{(a_{50}-x)/a_{to95}}]
\end{equation}

\item The \subcommand{ExponentialDecay}\ preference function has dependent variable $x$ and parameters $\theta = (\lambda)$, and is defined as,
\begin{equation}
...
\subsubsection*{\argument{KnifeEdge}}
...
\subsubsection*{\argument{AllValuesBounded}}
...
\subsubsection*{\argument{LogisticProducing}}
...
\subsubsection*{\argument{DoubleNormal}}
...
\subsubsection*{\argument{DoubleExponential}}
