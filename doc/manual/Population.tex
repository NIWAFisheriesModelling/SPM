...
\SPM\ implements two spatial structures, \emph{square} \textemdash the default (see Figure \ref{fig:SquareSpatialStructure}), and \emph{hexagonal} (see Figure \ref{fig:HexagonalSpatialStructure}. 
...
\begin{figure}[htp]
\resizebox{\textwidth}{!}{\includegraphics[width=\textwidth]{Figures/HexagonalStructure}}
 \caption{The \emph{hexagonal} spatial structure}
 \label{fig:HexagonalSpatialStructure}
\end{figure}
