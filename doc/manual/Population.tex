...
Recruitment processes are defined as  process that introduces new individuals into the model. \SPM\ implements three types of recruitment process, constant recruitment\index{Recruitment ! Constant},  \I{local Beverton-Holt recruitment}\index{Recruitment ! Local Beverton-Holt} \citep{1203}\NYI, and \I{Beverton-Holt recruitment}\index{Recruitment ! Beverton-Holt} \citep{1203}\NYI. 
...
Note that the local Beverton-Holt recruitment process requires a value for $SSB$ to resolve the stock-recruitment relationship. Here, a layer (which probably should be an abundance or biomass layer) must be provided.
