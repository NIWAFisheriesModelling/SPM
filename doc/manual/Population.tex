...
To specify an constant annual exploitation rate \index{Constant exploitation rate}(i.e., $U=0.2$) for categories `male' and `female', then, 
{\small{\begin{verbatim}
