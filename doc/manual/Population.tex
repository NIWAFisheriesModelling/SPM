...
\item The label of a numeric layer to be used as the base layer (defining the locations where the population can be present as well as the relative area of each cell)
...
\SPM\ implements three mortality processes. Natural mortality, event mortality, and a rate mortality. 
