...
\item a set of proportions for multiple categories. 
\item a set of proportions across aggregated categories, or 
\end{enumerate}
...
The later form can then be extended to include multiple categories, or multiple aggregated categories. For example, to describe immature males, mature males, and all females together for ages 1--4, a total of 12 proportions are required 
