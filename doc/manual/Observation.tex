...
Second, each set of observations is randomised, based on (i) the fitted values, (ii) the type of likelihood specified, and (iii) the variability parameters (e.g., \argument{error\_value} and \argument{process\_error}). 
