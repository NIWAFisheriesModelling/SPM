...
Prints the values in the layer (including user supplied layers, abundance and biomass layers, derived quantity layers, and meta-layers) for given year and at the end of a given time-step. 
