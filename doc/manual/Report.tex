...
\subsection{\I{Printing the partition biomass}}\index{Reports ! Partition biomass}
...
\subsection{\I{Printing a preference function summary}}\index{Reports ! Preference Functions}
...
\subsection{\I{Printing derived layers}}\index{Reports ! Derived layers}
...
\subsection{\I{Printing layers and meta-layers}}\index{Reports ! Layers and meta-layers}

Prints the values in the layer (including user supplied layers, abundance and biomass layers, derived layers, meta-layers and derived meta-layers) for given year and at the end of a given time-step. 
...
\subsection{\I{Printing the size-weight relationship}\label{sec:report-size-weight}}\index{Reports ! Size-weight}
...
\subsection{\I{Printing the size-at-age relationship}\label{sec:report-age-size}}\index{Reports ! Size-at-age}
...
\subsection{\I{Printing the weight-at-age relationship}\label{sec:report-age-weight}}\index{Reports ! Weight-at-age}
...
\subsection{\I{Printing the results of an MCMC}}\index{Reports ! MCMC}

Print the MCMC samples, objective function values, and proposal covariance matrix following an MCMC.

\subsection{\I{Printing the individual MCMC samples as they are calculated during an MCMC}}\index{Reports ! MCMC samples}

Print the individual MCMC samples for each new \textit{i}th sample as soon as they are calculated while doing an MCMC.

\subsection{\I{Printing the individual MCMC objective function values as they are calculated during an MCMC}}\index{Reports ! MCMC objective functions}

Print the individual MCMC objective function values (along with the proposal covariance matrix) for each new \textit{i}th sample as soon as they are calculated while doing an MCMC.
