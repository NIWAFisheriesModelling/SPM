...
\defSub{YCSYears} {Years for YCS values}
\defSub{Layer} {Name of the layer used to determine where recruitment occurs}
...
\par\textbf{\commandsubarg{Selectivity}{Type}{All-values}}\par
\defSub{V} {Defines the $V$ parameters (one for each age class) of the selectivity function}
\par\textbf{\commandsubarg{Selectivity}{Type}{All-values-bounded}}\par
...
\par\textbf{\commandsubarg{estimate[\textit{label}]}{Prior}{Uniform}}\par
\par\textbf{\commandsubarg{estimate[\textit{label}]}{Prior}{Uniform-Log}}\par
\par\textbf{\commandsubarg{estimate[\textit{label}]}{Prior}{Normal}}\par
\defSub{Mu}{Defines the mean $\mu$ of the normal prior}
\defSub{cv}{Defines the c.v. $c$ of the normal prior}
\par\textbf{\commandsubarg{estimate[\textit{label}]}{Prior}{Normal-by-stdev}}\par
...
\par\textbf{\commandsubarg{estimate[\textit{label}]}{Prior}{Lognormal}}\par
\defSub{Mu}{Defines the mean $\mu$ of the lognormal prior}
\defSub{cv}{Defines the c.v. $c$ of the lognormal prior}
\par\textbf{\commandsubarg{estimate[\textit{label}]}{Prior}{Beta}}\par
...
\par \defComLab{AgeingError}{Define ageing error with \textit{label}}\par
\defSub{Type} {The type of ageing error}
\par\textbf{\commandsubarg{AgeingError[\textit{label}]}{Type}{None}}\par
\par\textbf{\commandsubarg{AgeingError[\textit{label}]}{Type}{Normal}}\par
\defSub{c} {Parameter of the normal ageing error model}
\par\textbf{\commandsubarg{AgeingError[\textit{label}]}{Type}{Off-by-one}}\par
...
\par \defComLab{q}{Define a catchability constant with \textit{label}}\par
\defSub{q} {Value of the q parameter}
\subsection{Observation command and subcommand syntax}
\defComLab{ProportionsAtAge}{Define an observation using proportions-at-age data}\par
...
\defSub{Tolerance}{Define the tolerance on the sum-t-one error check in \SPM}
