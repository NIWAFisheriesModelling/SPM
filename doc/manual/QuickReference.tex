...
\defSub{SSB} {Define the label of the \command{derived\_parameter} that defines the SSB}
...
\par\textbf{\commandlabsubarg{preference\_function}{type}{exponential\_decay}}\par
\defSub{layer} {Defines the layer which supplies the preference function independent variable}
\defSub{alpha} {Defines the multiplicative constant $\alpha$}
...
\defSub{selectivities} {Define the selectivities applied to each category}
\defSub{size\_at\_age}{Define the age-weight relationships for each of the categories that the biomass is calculated from}
\par\textbf{\commandlabsubarg{layer}{type}{meta\_layer}}\par
...
\par \defComLab{Minimiser}{Define the an minimiser estimator with label}\par
\defSub{type} {Define the type of minimiser}
\par\textbf{\commandlabsubarg{minimiser}{type}{numerical\_differences}}\par
\defSub{max\_iterations} {Define the maximum number of iterations for the Numerical Differences minimiser}
\defSub{max\_evaluations} {Define the maximum number of evaluations for the Numerical Differences minimiser}
\defSub{step\_size} {Define the step-size for the Numerical Differences minimiser}
\defSub{gradient\_tolerance} {Define the gradient tolerance for the Numerical Differences minimiser}
\par\textbf{\commandlabsubarg{minimiser}{type}{DE\_solver}}\par
\defSub{max\_iterations} {Define the maximum number of iterations for the Differential Evolution minimiser}
\defSub{max\_evaluations} {Define the maximum number of evaluations for the Differential Evolution minimiser}
\defSub{step\_size} {Define the step-size for the Differential Evolution minimiser}
\defSub{gradient\_tolerance} {Define the gradient tolerance for the Differential Evolution minimiser}
\par \defComLab{MCMC}{Define the MCMC estimation arguments}\par
...
\par \defComLab{Profile}{Define the profile parameters, minimiser, and arguments}\par
...
\par\textbf{\commandlabsubarg{estimate}{prior}{uniform\_log}}\par
...
\par\textbf{\commandlabsubarg{estimate}{prior}{normal\_by\_stdev}}\par
...
\par \defComLab{ageing\_error}{Define ageing error with \argument{label}}\par
...
\defComLab{observation}{Define an observation}\par
...
\defSub{delta}{Define the delta robustifying constant for the distribution}
\defSub{simulate}{Defines if this observation should be simulated when doing simulations}
\par\textbf{\commandlabsubarg{observation}{type}{proportions\_by\_age}}\par
\defSub{year} {Define the year that the observation applies to}
\defSub{time\_step} {Define the time-step that the observation applies to}
\defSub{proportion\_time\_step} {Define the interpolated proportion of the time-step passes that the observation applies to}
\defSub{categories} {Define the categories}
...
\defSub{delta}{Define the delta robustifying constant for the distribution}
\defSub{simulate}{Defines if this observation should be simulated when doing simulations}
\subsection{Reporting command and subcommand syntax}
\defComLab{report}{Define an output report}\par
...
\par\textbf{\commandlabsubarg{report}{type}{derived\_parameter}}\par
\defSub{Label} {Define the label of the derived parameter to print}
\defSub{file\_name} {Define the name of the output file where the report is written}
\par\textbf{\commandlabsubarg{report}{type}{Parameters}}\par
\defSub{file\_name} {Define the name of the output file where the report is written}
\par\textbf{\commandlabsubarg{report}{type}{Objective}}\par
\defSub{file\_name} {Define the name of the output file where the report is written}
