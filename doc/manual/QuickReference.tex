...
\par\defComLab{profile}{Define the profile parameters, minimiser, and arguments}\par\par
...
\par\defComArg{estimate}{parameter\_name}{Estimate a free parameter}\par\par
...
\par\defComLab{q}{Define a catchability constant with \argument{label}}\par\par
...
\defSub{file\_name} {Define the name of the output file where the report is written}
\par\textbf{\commandlabsubarg{report}{type}{Parameter\_vector}}\par
\defSub{file\_name} {Define the name of the output file where the report is written}
...
\defComArg{include}{file\_name}{Include an external file}\par\par
