...
\usepackage[font=bf,format=hang,labelsep=colon,justification=justified,singlelinecheck=false]{caption}

% hyperref for HTML links within pdf 
%EXAMPLE: \href{http://www.niwa.co.nz}{NIWA}
\usepackage[a4paper,bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
%            pdfpagemode=UseNone,pdfpagelayout=TwoPageRight,
            pdftitle={Spatial Population Model (SPM) Users Manual}, 
            pdfauthor={Alistair Dunn; Scott Rasmussen}, 
...
\usepackage{listings} 
\lstset{basicstyle=\ttfamily\small,columns=fullflexible} %10pt courier, non-aligned columns
...
\newcommand{\commandsubarg}[3] {\small{\command{#1}\subcommand{.#2}\argument{=#3}}}
\newcommand{\commandlabsubarg}[3] {\small{\command{#1\texttt{[label]}}\subcommand{.#2}\argument{=#3}}}
