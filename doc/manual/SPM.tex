...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
            ...
            pdftitle={Spatial Population Model (SPM) Users Manual}, 
            pdfauthor={Alistair Dunn; Scott Rasmussen; Sophie Mormede}, 
            pdfsubject={Spatial Population Model, NIWA Technical Report 138},
            pdftex]{hyperref}
\hypersetup{
...
\newcommand{\VER}{v\input{SPMversion.tex}} % SPM program version
\newcommand{\SPM}{\texttt{SPM}} % SPM short  name
\newcommand{\SPMName}{Spatial Population Model} %SPM long name
\newcommand{\authors}{\href{mailto:"Alistair Dunn"<alistair.dunn@niwa.co.nz>?subject=SPM:}{authors}} %hyper ref for email
\newcommand{\Organisation}{National Institute of Water \& Atmospheric Research Ltd.} %NIWA
\newcommand{\ReportNumber}{NIWA Technical Report 138}
\newcommand{\ManualRef}{Dunn, A.; Rasmussen, S.; Mormede, S. (\DocYear). \SPMName\ User Manual, \SPM\ \VER. \Organisation\ \emph{\ReportNumber}. \ref{TotPages} p.} % full document reference
...
% Title page
\pdfbookmark[1]{SPM Users Manual}{title}
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\vspace{1cm}
		\LARGE Alistair Dunn, Scott Rasmussen, and Sophie Mormede \\ %Document authors
		...
		\Large NIWA Technical Report 138 \\%Document Date
		\Large ISSN 1174-2631 \\%Document Date
		\Large 2014 \\%Document Date
...
$\vcenter{Citation: \ManualRef}$ & $\vcenter{\hbox{\includegraphics[height=1.8cm,width=1.8cm]{Figures/QR_code}}}$\\
\end{tabulary}
...
\clearemptydoublepage{}
\input{syntax/PopulationSyntax}\label{sec:syntax}
\clearemptydoublepage{}
\input{syntax/EstimationSyntax}
\clearemptydoublepage{}
\input{syntax/ObservationSyntax}
\clearemptydoublepage{}
\input{syntax/ReportSyntax}
\clearemptydoublepage{}
\input{syntax/GeneralSyntax}
