...
\usepackage{titling} % better control over titles
...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
            ...
            pdfsubject={Spatial Population Model},
            pdftex]{hyperref}
\hypersetup{
...
\newcommand{\ManualRef}{Dunn, A.; Rasmussen, S.; Mormede, S. (\DocYear) \SPMName\ User Manual, \SPM\ \VER. \Organisation\ \emph{Unpublished report}. \ref{TotPages} p.} % full document reference
\title{\SPMName\ User Manual \\\SPM\ \VER} %Document title
\author{Alistair Dunn, Scott Rasmussen, and Sophie Mormede}  %Document authors
\predate{test}
\date{ NIWA Technical Report 135\\ISSN 1174-2631\\\DocYear}
...
\begin{figure}[htp]
  \begin{center}
   \includegraphics[height=5cm,width=5cm]{Figures/SPM}
  \end{center}
\end{figure}
