...
\defType{String}
\defDefault{No default}
\defValue{A valid likelihood; either Dirichlet, multinomial, or lognormal}
...
\defSub{categories2} {Define the categories that, in combination with the numberator categories, make up the denominator}
\defType{String vector}
\defDefault{No default}
\defValue{Valid categories from \commandsub{model}{categories}}
...
\defType{String}
\defDefault{No default}
\defValue{A valid likelihood; either binomial or binomial-approx}
...
\defType{String}
\defDefault{No default}
\defValue{A valid likelihood; either lognormal or normal}
...
\defType{String}
\defDefault{No default}
\defValue{A valid likelihood; binomial is the only valid likelihood}
