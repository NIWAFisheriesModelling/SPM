...
\defType{String vector}
\defDefault{No default}
\defCondition{The arguments cannot be meta-layers}
...
\defType{String vector, of length the number of \argument{initialisation\_phases}}
\defDefault{No default}
\defCondition{The argument must be categorical layers}
...
\defType{Integer vector or integer range}
\defDefault{If not specified, calculation is carried out at every model year}
...
\defType{String vector}
\defDefault{No default}
\defValue{Valid layers or meta-layers}
