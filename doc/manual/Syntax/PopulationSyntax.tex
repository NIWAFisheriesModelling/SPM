...
\defType{Estimable vector of length \commandlabsub{constant\_recruitment}{categories}}
\defDefault{None}
...
\defType{String}
\defDefault{None}
\defValue{A valid layer as defined by \command{layer}. If a numeric layer, then recruitment is in proportion to the layer values. If a logical layer, then recruitment occurs in cells where the layer value is \argument{TRUE}. Note that the layer values must be non-negative}
...
\defType{String}
\defDefault{None}
\defValue{A valid layer as defined by \command{layer}. If a numeric layer, then mortality applied is the mortality rate times the value of the layer. If a logical layer, then mortality occurs in cells where the layer value is \argument{TRUE}. Note that the layer values must be non-negative}
...
\defType{String vector}
\defDefault{None}
\defValue{Valid labels from \command{size\_at\_age}}
...
\defType{String}
\defDefault{None}
\defValue{A valid layer as defined by \command{layer}. If a numeric layer, then rate applied to each cell is multiplied by the value of the layer. If a logical layer, then the transition occurs in cells where the layer value is \argument{TRUE}. Note that the layer values must be non-negative}
...
\defType{String}
\defDefault{None}
\defValue{A valid layer as defined by \command{layer}. If a numeric layer, then rate applied to each cell is multiplied by the value of the layer. If a logical layer, then the transition occurs in cells where the layer value is \argument{TRUE}}
...
\subsubsection[Preference movement]{\commandlabsubarg{process}{type}{preference\_movement}}
...
\defType{String}
\defDefault{None}
\defValue{A valid layer as defined by \command{layer}. If a numeric layer, then value is the sum of the each cell is multiplied by the value of the layer. If a logical layer, then the sum is only for cells where the layer value is \argument{True}}
...
\defType{String}
\defDefault{None}
\defValue{A valid layer as defined by \command{layer}. If a numeric layer, then value is the sum of the each cell biomass multiplied by the value of the layer. If a logical layer, then the sum is only for cells where the layer value is \argument{True}}
...
\defComLab{size\_at\_age} {Define a size-at-age relationship with label}
...
\subsubsection[von Bertalanffy]{\commandlabsubarg{size\_at\_age}{type}{von\_Bertalanffy}}
...
\subsubsection[Schnute]{\commandlabsubarg{size\_at\_age}{type}{Schnute}}
