...
\defSub{r0\_layer} {Define the label of the layer that defines the spawning stock biomass (SSB) for each cell in each year}
\defType{String}
\defDefault{No default}
\defValue{Must be a valid \command{layer} label}
...
\defSub{layer} {Define the label of a layer that defines the cells to apply the adjacent cell movement event}
\defType{String}
\defDefault{No default}
\defValue{A valid layer defined by \command{layer}}
...
\defType{String vector}
\defDefault{No default}
\defValue{A complete set of values of labels in \argument{layer} in order of \argument{category\_labels}}
...
\defDefault{No default}
\defValue{A complete set of values of labels in \argument{layer} in order of \argument{category\_labels}. Each value of \argument{category\_values} must be greater than or equal to zero}
