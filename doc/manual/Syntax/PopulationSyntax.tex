...
\defSub{layer}{Define the layer that specify the Holling predator abundance (or biomass)}
\defType{String}
\defDefault{No default}
\defValue{A valid layers defined by \command{layer} of \texttt{type} abundance or biomass}
