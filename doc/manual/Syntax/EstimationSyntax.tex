...
\defDefault{no default}
\defValue{Defines the points during the MCMC iterations to re-evaluate the MCMC step-size argument}
...
\begin{itemize}
  ...
  \item uniform log
  \item normal
  \item normal by standard deviation
  \item lognormal
  \item Beta
\end{itemize}
...
\subsubsection[Normal-by-stdev prior]{\commandlabsubarg{prior}{type}{normal\_by\_stdev}}
