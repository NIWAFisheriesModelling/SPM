...
\subsubsection[Numerical differences minimiser]{\commandlabsubarg{MPD}{Type}{NumericalDifferences}} 
...
\subsubsection[Differential evolution minimiser]{\commandlabsubarg{MPD}{Type}{DESolver}} 
