...
\begin{enumerate}
  ...
  \item Print a derived quantity
	\item Print a derived quantity by cell
  ...
  \item Print the results of an MCMC
  \item Print the MCMC samples as they are calculated
  \item Print the MCMC objective function values as they are calculated
\end{enumerate}
...
\subsubsection[Print a derived quantity by cell]{\commandlabsubarg{report}{type}{derived\_quantity\_by\_cell}}

\defSub{derived\_quantity\_by\_cell} {Define the label of the derived quantity by cell to print}
\defType{String}
\defDefault{No default}
\defValue{A valid label from \command{derived\_quantity\_by\_cell}}
...
\subsubsection[Print the estimated parameter values out as a vector]{\commandlabsubarg{report}{type}{estimate\_value}\label{sec:InputFileFormat}}
...
\defType{Switch}
\defDefault{True if \texttt{file\_name} is not defined, otherwise False.}
\defValue{Either True or False. Use False if you want to output this to a file in a format that it can be read by SPM as a parameter input file}
...
\subsubsection[Print the results of an MCMC]{\commandlabsubarg{report}{type}{MCMC}}
...
\subsubsection[Print the MCMC samples as they are calculated]{\commandlabsubarg{report}{type}{MCMC\_samples}}
...
\subsubsection[Print the MCMC objective function values as they are calculated]{\commandlabsubarg{report}{type}{MCMC\_objectives}}
