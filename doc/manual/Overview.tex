...
A model in \SPM\ is specified by the \config\ in four parts \textemdash the population section, the estimation section, the observation section, and the output section. These sections completely describe a model implemented in \SPM. See Sections \ref{sec:population-syntax}, \ref{sec:estimation-syntax}, \ref{sec:observation-syntax}, and \ref{sec:output-syntax} for details and specification of \SPM s command and subcommand syntax. 
