...
BOOST_FIXTURE_TEST_CASE( ProportionsByCategoryObservation, C3x3_Fixture ) {
  ...
  BOOST_CHECK_CLOSE(pComparison->dExpectedValue, 0.40717124759128087, 1e-9);
  BOOST_CHECK_CLOSE(pComparison->dScore, 213.63064317625387, 1e-9);
  ...
  BOOST_CHECK_CLOSE(pComparison->dExpectedValue, 0.40717124759128082, 1e-9);
  BOOST_CHECK_CLOSE(pComparison->dScore, 28.40182171792668, 1e-9);
  ...
  BOOST_CHECK_CLOSE(pComparison->dObservedValue, 0.30, 1e-9);
  BOOST_CHECK_CLOSE(pComparison->dExpectedValue, 0.40717124759128082, 1e-9);
  BOOST_CHECK_CLOSE(pComparison->dScore, 40.825811226916983, 1e-9);
