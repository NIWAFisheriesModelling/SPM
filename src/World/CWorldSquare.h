...
public:
  ...
  double                     getArea() { return dArea; }
	...
	double                     getPopulationForAge(int AgeIndex);
	double                     getPopulationInCategoryForAge(int AgeIndex, int CategoryIndex);
	double                     getPopulationForCategory(int CategoryIndex);
	void                       build();
	void                       zeroGrid();
	void                       loadDummyData();
