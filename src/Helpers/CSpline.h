/*  https://www.marcusbannerman.co.uk/index.php/home/latestarticles/42-articles/96-cubic-spline-class.html
...
namespace magnet {
  namespace math {
    ...
    private:
      ...
      {
        if (size() < 2)
          throw ("Spline error: Spline requires at least 2 points");
